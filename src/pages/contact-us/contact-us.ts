...
export class ContactUsPage {
  ...
  kirimPesan: string = "";
  userInput: any = {"email":"", "subject":"Feedback", "message":""}
  result:any = [];
  ...
  send() {
    ...
    // Fields
    postData.append('subject', this.userInput.subject);
